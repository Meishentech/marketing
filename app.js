...
function nextAssocEvent(associationId){
  return ASSOC_EVENTS.filter(e => e.association_id === associationId && !['已完成','取消'].includes(e.event_status))
...
function openAssociationModal(id){
  ...
  document.getElementById('am-type').value = a?.association_type || '技師公會';
  document.getElementById('am-status').value = a?.join_status || '已加入';
...
function openAssocFeeModal(id){
  ...
  document.getElementById('af-status').value = f?.payment_status || '未繳';
...
function openAssocBenefitModal(id){
  ...
  document.getElementById('ab-type').value = b?.benefit_type || '其他';
  document.getElementById('ab-status').value = b?.usage_status || '未使用';
...
function openAssocPubModal(id){
  ...
  document.getElementById('ap-status').value = p?.material_status || '未開始';
...
function openAssocEventModal(id){
  ...
  document.getElementById('ae-role').value = e?.meisun_role || '';
  ...
  document.getElementById('ae-status').value = e?.event_status || '待確認';
